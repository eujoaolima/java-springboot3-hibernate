...
import com.jpa.hibernate.advanced.mappings.cruddemo.entity.*;
...
public class CruddemoApplication {
	...
	private void addMoreCoursesForStudent(AppDAO appDAO) {
		...
		Course tempCourse1 = new Course("Como montar um carro do zero");
		Course tempCourse2 = new Course("Como usar TDD");
		Course tempCourse3 = new Course("Como tocar violão");

		tempStudent.addCourses(tempCourse1);
		tempStudent.addCourses(tempCourse2);
		tempStudent.addCourses(tempCourse3);
	...
	private void createCourseAndStudents(AppDAO appDAO) {
		Course tempcourse = new Course("Fuga das galinhas");
		Student tempStudent1 = new Student("Bob" , "o Bobo", "bob@gmail.com");
		Student tempStudent2= new Student("Charlie" , "Brown", "charlie@gmail.com");
	...
	private void createCourseAndReviews(AppDAO appDAO) {
		Course tempCourse = new Course("Batata");
		tempCourse.addReview(new Review("Potatoes..."));
		tempCourse.addReview(new Review("Patatas..."));
		System.out.println("Saving the course...");
		System.out.println(tempCourse);
		System.out.println(tempCourse.getReviews());
